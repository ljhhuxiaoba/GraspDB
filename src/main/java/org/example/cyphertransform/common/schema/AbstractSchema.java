package org.example.cyphertransform.common.schema;
...
import org.example.cyphertransform.IgnoreMeException;
...
public class AbstractSchema<G extends GlobalState<?, ?, ?>, A extends AbstractTable<?, ?, G>> implements ICypherSchema {
