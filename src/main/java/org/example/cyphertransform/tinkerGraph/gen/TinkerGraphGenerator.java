...
public class TinkerGraphGenerator {
    ...
    public TinkerGraphGenerator(TinkerGlobalState globalState){
        this.globalState = globalState;
    }

    public static List<CypherQueryAdapter> createGraph(TinkerGlobalState globalState) throws Exception {
        return new TinkerGraphGenerator(globalState).generateGraph(globalState.getSchema());
    }

    public List<CypherQueryAdapter> generateGraph(TinkerSchema schema) throws Exception {
