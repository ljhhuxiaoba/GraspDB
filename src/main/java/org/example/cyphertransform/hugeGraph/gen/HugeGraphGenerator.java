...
import org.example.cyphertransform.cypher.ast.Direction;
...
import org.example.cyphertransform.cypher.standard_ast.*;
...
public class HugeGraphGenerator {
    ...
    public HugeGraphGenerator(HugeGlobalState globalState){
        this.globalState = globalState;
    }

    public static List<CypherQueryAdapter> createGraph(HugeGlobalState globalState) throws Exception {
        return new org.example.cyphertransform.hugeGraph.gen.HugeGraphGenerator(globalState).generateGraph(globalState.getSchema());
    }

    public List<CypherQueryAdapter> generateGraph(HugeSchema schema) throws Exception {
