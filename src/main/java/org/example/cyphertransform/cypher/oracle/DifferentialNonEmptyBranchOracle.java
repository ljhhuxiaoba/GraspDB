package org.example.cyphertransform.cypher.oracle;

import org.example.cyphertransform.CypherTransform.CypherVisitorImp;
import org.example.cyphertransform.CypherTransform.CypherVisitorImpNoUpdate;
...
import org.example.cyphertransform.exceptions.ResultMismatchException;
...
// 检查返回结果的用时
    ...
    public DifferentialNonEmptyBranchOracle(G globalState, IQueryGenerator<S, G> generator) throws IOException {
      ...
      //  this.fw=new FileWriter("/home/lanjunhao/Projects/"+globalState.getOptions().getDatabaseType()+"_mr_removed_"+globalState.getOptions().getRelation_removed()+".txt",true);
        this.fw = new FileWriter("C:\\Users\\lanjunhao\\Desktop\\log.txt", true);
    }
