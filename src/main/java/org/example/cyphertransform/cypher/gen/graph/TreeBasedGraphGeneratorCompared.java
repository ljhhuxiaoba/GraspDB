...
import org.example.cyphertransform.cypher.gen.SubgraphManager;
...
public class TreeBasedGraphGeneratorCompared<G extends CypherGlobalState<?,S>, S extends CypherSchema<G,?>> implements IGraphGenerator<G> {
    ...
    public TreeBasedGraphGeneratorCompared(G globalState){
        this.globalState = globalState;
        subgraphManager = new SubgraphManager(globalState.getSchema(), globalState.getOptions(), 0);
    }
