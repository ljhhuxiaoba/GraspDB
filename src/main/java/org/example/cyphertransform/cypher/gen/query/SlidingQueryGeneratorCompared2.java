...
public class SlidingQueryGeneratorCompared2<S extends CypherSchema<G,?>,G extends CypherGlobalState<?,S>> extends GraphGuidedQueryGenerator<S,G> {
    ...
    public SlidingQueryGeneratorCompared2(GraphManager graphManager) {
        super(graphManager);
    }
