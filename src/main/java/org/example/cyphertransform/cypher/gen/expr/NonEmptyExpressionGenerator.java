package org.example.cyphertransform.cypher.gen.expr;

import org.example.cyphertransform.Randomly;
import org.example.cyphertransform.cypher.gen.assertion.BooleanAssertion;
import org.example.cyphertransform.cypher.gen.assertion.ComparisonAssertion;
import org.example.cyphertransform.cypher.gen.assertion.ExpressionAssertion;
import org.example.cyphertransform.cypher.gen.assertion.StringMatchingAssertion;
...
import org.example.cyphertransform.neo4j.schema.Neo4jSchema;
...
import org.example.cyphertransform.cypher.ast.analyzer.INodeAnalyzer;
...
//    }
    ...
    public IExpression generateListWithBasicType(int depth, CypherType type){
        Randomly randomly = new Randomly();
        int randomNum = randomly.getInteger(1,3);
