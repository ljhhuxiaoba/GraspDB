...
public class NodeIdentifier implements INodeIdentifier {
    ...
    public static NodeIdentifier createNodeRefFromAlias(Alias alias){
//        return new NodeIdentifier(nodeIdentifier.getName(), new ArrayList<>(), new ArrayList<>());
        return new NodeIdentifier(alias.getName(), null, null);
    }
    public static NodeIdentifier createNodeRef(INodeIdentifier nodeIdentifier){
//        return new NodeIdentifier(nodeIdentifier.getName(), new ArrayList<>(), new ArrayList<>());
        return new NodeIdentifier(nodeIdentifier.getName(), nodeIdentifier.getLabels(), nodeIdentifier.getProperties());
    }
