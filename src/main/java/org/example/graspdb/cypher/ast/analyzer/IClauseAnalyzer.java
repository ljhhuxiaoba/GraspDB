...
//    void setInQuery(Boolean b);
    ...
    /**
     * 本clause定义的path identifier
     * @return
     */
    List<IPathAnalyzer> getLocalPathIdentifiers();
    ...
    /**
     * 本clause的作用域中可以使用的path identifier，即where中可以使用的，包括了本地定义的和继承自之前clause的
     * @return
     */
     ...
     * @return
     */
    List<IPathAnalyzer> getAvailablePathIdentifiers();
    ...
    /**
     * 本clause继承自上一clause的path identifier，可以在定义pattern和alias时使用
     * @return
     */
    List<IPathAnalyzer> getExtendablePathIdentifiers();
